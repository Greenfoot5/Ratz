...
public class ProfileFileReader {
	private static final String FILE_PATH = "profileFile2.txt";
	...
	public static ArrayList<String> getDeafaultLevelsNames() {
		...
		File directoryPath = new File("levels\\default_levels");
	...
	public static ArrayList<String> getCreatedLevelsNames() {
		// Creating a File object for directory
		File directoryPath = new File("levels\\created_levels");
	...
	public static ArrayList<String> getSavedGamesNames(String profileName) {
		// Creating a File object for directory
		File directoryPath = new File("levels\\saved_games\\" + profileName);
